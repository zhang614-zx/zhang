...
class SegmentationTrainingApp:
    ...
    def computeBatchLoss(self, batch_ndx, batch_tup, batch_size, metrics_g,
        ...
        with torch.no_grad():
            ...
            tn = ((1 - predictionBool_g) * (~label_g)).sum(dim=[1, 2, 3]) # 新增

            metrics_g[METRICS_LOSS_NDX, start_ndx:end_ndx] = diceLoss_g
            metrics_g[METRICS_TP_NDX, start_ndx:end_ndx] = tp
            metrics_g[METRICS_FN_NDX, start_ndx:end_ndx] = fn
            metrics_g[METRICS_FP_NDX, start_ndx:end_ndx] = fp
            metrics_g[METRICS_TN_NDX, start_ndx:end_ndx] = tn # 新增
    ...
    def logMetrics(self, epoch_ndx, mode_str, metrics_t):
        ...
        allNegative_count = sum_a[METRICS_TN_NDX] + sum_a[METRICS_FP_NDX] # 新增
        ...
        metrics_dict['percent_all/fp'] = \
            sum_a[METRICS_FP_NDX] / (allNegative_count or 1) * 100 # 修改
        metrics_dict['percent_neg/tn'] = \
            sum_a[METRICS_TN_NDX] / (allNegative_count or 1) * 100 # 新增
        metrics_dict['pr/specificity'] = sum_a[METRICS_TN_NDX] / (allNegative_count or 1) * 100 # 新增 特异性
        ...
        total_pixels = allLabel_count + allNegative_count
        metrics_dict['pr/accuracy'] = (sum_a[METRICS_TP_NDX] + sum_a[METRICS_TN_NDX]) / (total_pixels or 1) # 新增
        ...
        log.info(("E{} {:8} "
                  ...
                  + "{pr/recall:.4f} recall, "
                  + "{pr/specificity:.4f} specificity, "
                  + "{pr/accuracy:.4f} accuracy, "
        ...
        score = metrics_dict['pr/f1_score'] # 修改
